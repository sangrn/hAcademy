...
<body>
	...
	<section>
		...
		<article>
			<div class="slider">
				<img alt="daisies"
					src="${pageContext.request.contextPath}/images/daisies.jpg">
				<img alt="plant"
					src="${pageContext.request.contextPath}/images/plant.jpg"> 
				<img alt="succulents"
					src="${pageContext.request.contextPath}/images/succulents.jpg">
			</div>
		</article>
