...
<body>
	...
	<table>
		...
		<tr>
			<td><c:forEach items="${board.attachs}" var="attach">
					<p>
						<a
							href="${pageContext.request.contextPath}/download?filename=${attach.path}/${attach.uuid}">${attach.origin}</a>
					</p>
				</c:forEach></td>
		</tr>
		<tr>
		...
		<div class="col-10 mx-auto">
			<div class="form-group clearfix">
				...
				<form id="frmReplyWrite">
					<input type="text" class="form-control" placeholder="댓글 제목을 입력하세요"
						name="title" id="title">
	...
	<div class="container col-10 mx-auto reply-wrapper"></div>
	</main>
	<script>
